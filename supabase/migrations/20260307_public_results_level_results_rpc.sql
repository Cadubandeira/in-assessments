-- Migration: RPC para cálculo de resultados de níveis em PublicResults
-- Date: 2026-03-07
-- Goal: calcular levelScore/maxLevelScore no banco para links públicos sem depender de RLS client-side em questions/alternatives
...
IS 'Retorna mapa de resultados por nível (scores e máximos) a partir do assessment_event para uso em PublicResults.';
